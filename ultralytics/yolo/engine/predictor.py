...
class BasePredictor:
    ...
    def stream_inference(self, source=None, model=None):
        ...
        if not self.done_warmup:
            self.model.warmup(imgsz=(1 if self.model.pt or self.model.triton else self.dataset.bs, 7 if (not isinstance(source, Path)) or source.suffix != '.jpg' else 3, *self.imgsz))
